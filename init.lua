...
local on_attach_global = function(_, bufnr)
  ...
  nmap('<leader>ds', require('telescope.builtin').lsp_document_symbols, 'Search [D]ocument [S]ymbols')
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --       -- server.on_attach = servers['clangd'].on_attach
      --       -- server.on_attach = servers[server_name].on_attach
